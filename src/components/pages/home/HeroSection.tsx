  ...
  return (
    <div aria-labelledby="hero-heading">
      ...
      <p className="text-muted-foreground mt-4 text-base">
        Vegan Ipsum is a free, open-source tool to generate cruelty-free, vegan-themed placeholder text and plant-based
        lorem ipsum for your web design, app development, and creative projects. Whether you need ethical filler text
        for websites, presentations, or mockups, Vegan Ipsum provides meaningful, sustainable content tailored for
        compassionate designers and developers.
      </p>
