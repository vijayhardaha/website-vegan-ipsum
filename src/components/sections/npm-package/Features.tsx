...
/**
 * Feature card item for NPM Package.
 *
 * @type {Card}
...
const cards: Card[] = [
  {
    ...
    content: 'Extremely lightweight and dependency-free, keeping your bundle size small and your project fast.',
  },
  {
    icon: 'fcWorkflow',
...
export default function Features(): JSX.Element {
  return (
    <Section id="features" aria-label="Features of the Vegan Ipsum NPM Package" className="bg-secondary-muted">
      <Container>
        <SectionHeader
          heading={
            <>
