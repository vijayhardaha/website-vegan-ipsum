...
function ClassBasedSection(): JSX.Element {
  return (
...
console.log(vegan.generateParagraphs(7));`}
      ...
      <p>
        Use this approach when you need consistent formatting across multiple calls or want full control over how the
        text is structured.
      </p>
    </RevealOnScroll>
  );
...
function FunctionalSection(): JSX.Element {
  return (
    <RevealOnScroll delay={0.2} className="space-y-4 md:space-y-6">
      <h3 className="mt-8 mb-2 text-lg">Functional Usage:</h3>
      <p>
        For quick and simple use cases, call the default exported function. It generates text immediately and accepts an
...
console.log(customText);`}
      ...
      <p>
        This form is best for one-off calls, CLI usage, or situations where you don&apos;t need to maintain a reusable
        instance.
      </p>
    </RevealOnScroll>
  );
