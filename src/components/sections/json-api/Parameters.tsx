      ...
      <Container>
        ...
        >
          <RevealOnScroll delay={0}>
            <p>
              Customize the API output using the following request parameters. These options provide full control over
              the volume, unit type, and format of the generated placeholder text to perfectly fit your UI layout.
            </p>
          </RevealOnScroll>
          ...
          <RevealOnScroll delay={0.2}>
            <InfoBox>
              Use the <code>format=html</code> parameter when injecting content directly into web pages. This preserves
              the intended paragraph structure without requiring additional processing on the client side.
            </InfoBox>
          </RevealOnScroll>
        </SectionHeader>
      </Container>
