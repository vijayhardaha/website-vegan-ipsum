  ...
  return (
    <RevealOnScroll delay={0.1}>
      ...
      <ul className="list-disc space-y-2 pl-8">
        ...
        <li>
          <strong>Efficiency:</strong> Use the <code>--copy</code> flag in conjunction with system clipboard managers to
          create a seamless, single-command copy-paste workflow.
        </li>
        ...
        <li>
          <strong>Mock Data Variety:</strong> Experiment with varying counts and units to produce randomized, realistic
          content for UI mockups and client demonstrations.
        </li>

        <li>
          <strong>Rapid Prototyping:</strong> Utilize the <code>--format html</code> flag to generate semantic markup
          instantly, speeding up the initial stages of web development.
        </li>
      </ul>
    </RevealOnScroll>
  );
...
function AdditionalResourcesSection(): JSX.Element {
  return (
    <RevealOnScroll delay={0.2}>
      <h3 className="mt-8 mb-2 text-lg">Additional Resources:</h3>

      <p>
        For programmatic usage, refer to the <Link href="/npm-package">Vegan Ipsum NPM Package</Link> documentation for
        detailed API references and implementation examples.
      </p>
