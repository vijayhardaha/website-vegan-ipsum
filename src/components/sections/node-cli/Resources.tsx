      ...
      <Container>
        ...
        >
            ...
            <ul className="list-disc space-y-2 pl-8">
              ...
              <li>
                ...
                <Link
                  ...
                  aria-label="awk — Visit the GNU Awk documentation"
                >
                  <code>awk</code>
                </Link>
                , or{' '}
                <Link
                  ...
                  aria-label="sed — Visit the GNU Sed documentation"
                >
                  <code>sed</code>
                </Link>{' '}
          ...
          <RevealOnScroll delay={0.2}>
            ...
            <p>
              For programmatic usage, refer to the <Link href="/npm-package">Vegan Ipsum NPM Package</Link>{' '}
