...
const cards: Card[] = [
  ...
  },
  {
    ...
    content: 'Add personality and ethical alignment to personal or professional projects with thematic filler content.',
  },
  {
...
export default function UseCases(): JSX.Element {
  return (
    <Section id="use-cases" className="bg-secondary-muted" aria-label="Use cases and applications of Vegan Ipsum">
      <Container>
        <SectionHeader
          heading={
            <>
