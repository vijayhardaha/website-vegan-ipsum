            ...
            <RevealOnScroll delay={0} className="space-y-4 md:space-y-6">
              ...
              <ul className="space-y-4 text-sm">
                {[
                  ...
                  <>
                    <strong>Zero external dependencies</strong>, making it lightweight, fast, and easy to audit for
                    security and performance.
                  </>,
                  <>
                    Employs <strong>functional programming</strong> principles to produce predictable and pure
                    functions, improving testability and reliability.
                  </>,
                  <>
                    Supports both{' '}
                    <Link
                  ...
                  <>
                    Actively maintained with <strong>semantic versioning</strong>, ensuring new features and bug fixes
                    are delivered predictably.
                  </>,
                  <>
                    <strong>Open-source on GitHub</strong>, welcoming community contributions and ensuring transparency
                    in development.
                  </>,
                ].map((feature, index) => (
